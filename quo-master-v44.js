/* Quo v44 - canonical editor master.
...
(function(){
  ...
  /* Keep menu input forgiving without a separate cleanup patch. */
  try{
  ...
  if(!document.getElementById('quoMasterV44Style')){
    const st=document.createElement('style');st.id='quoMasterV44Style';st.textContent=`
